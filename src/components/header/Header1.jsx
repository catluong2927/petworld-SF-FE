              ...
              <ul className="menu-list">
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    ...
                    <li>
                      <Link  to="/login">
                        <p className={currentRoute === "/login" ? "active" : ""}>
                          Login
                        </p>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link  to="/team">
                        <p className={currentRoute === "/team" ? "active" : ""}>
                          Our Team
                        </p>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link  to="/faq">
                        <p className={currentRoute === "/faq" ? "active" : ""}>
                          Faq
                        </p>
                      </Link>
                    </li>
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    <li>
                      <Link  to="/shop">
                        <p className={currentRoute === "/shop" ? "active" : ""}>
                          Shop
                        </p>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link  to="/cart">
                        <p className={currentRoute === "/cart" ? "active" : ""}>
                          Cart
                        </p>
                      </Link>
                    </li>
              ...
              <div className="for-mobile-menu d-lg-none d-block">
                <div className="hotline mb-5">
                  <div className="hotline-info">
                    ...
                    <h6>
                      <p href="tel:+1(541)754-3010">+1 (541) 754-3010</p>
                    </h6>
                  </div>
                </div>
