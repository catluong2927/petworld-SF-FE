...
alter table `service_package_review` add constraint `FK_service_package_review_service_packages` foreign key(service_package_id) references service_packages(`id`);
